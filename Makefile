...
help:
	...
	@echo '    make bindata               Run asset bindata.'
...
build:
	...
	go build -ldflags "-w -s -X github.com/NurfitraPujo/finance-tracker/build.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/NurfitraPujo/finance-tracker/build.Version=${VERSION} -X github.com/NurfitraPujo/finance-tracker/build.Environment=${APP_ENV} -X github.com/NurfitraPujo/finance-tracker/build.Date=${BUILD_DATE}" -o bin/${APP_NAME} -trimpath ./cmd/main.go
